...
public class MyDLL<E> implements ListADT<E> {
	...
	/**
	 * Private inner class representing a node in the doubly-linked list. Each node
	 * contains the element and references to the next and previous nodes.
	 */
	...
	/**
	 * Helper method to get the node at a specific index. Traverses from the closer
	 * end of the list for efficiency.
	 * 
	...
	/**
	 * Private inner class that implements the Iterator interface. Provides a way to
	 * iterate through the list without exposing the internal structure.
	 */
